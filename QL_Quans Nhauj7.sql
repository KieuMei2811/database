...
VALUES ('NV01','Ho Thi Kieu','Quang Tri','F','2003-11-28','0768547186'),
 ...
 -- VIEW --
 -- *** Cho biết giá trung bình của từng loại Danh Mục
 ...
 -- *** Hiển thị thông tin về đơn hàng: Tên Khách Hàng,Phone,Ngày,Số Lượng, 
 ...
 -- *** Cho biết thông tin nhân viên chỉ phục vụ một lần.
 ...
 -- Stored Procedure --
 -- *** Viết thủ tục xóa nhân viên có mã "NV02"
 delimiter //
