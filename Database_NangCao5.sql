...
Create view Total_DoanhSO as select CTHD_Xuat.Mahang,Tenhang,Tenloai, sum(Soluong*Dongia)
from DoanhSo where CTHD_Xuat.Mahang = Hang_Hoa.Mahang Group by CTHD_Xuat.Mahang 
Having sum(Soluong * Dongia) >= 100;
