...
Values ('C35','2022-10-06','M3','N3','Chua Xuat');

-- INDEX --
CREATE INDEX index_TenNCC ON nha_cungcap(TenNCC);
select * 
FROM nha_cungcap
WHERE TenNCC = 'Dong Tien';
-- Xóa INDEX --
Drop INDEX index_TenNCC ON nha_cungcap

-- b. Tạo INDEX cho ngày nhập. Sau đó xem lại bảng hóa đơn nhập 
-- c. Tạo một INDEX không cho phép người sử dụng nhập số điện thoại trùng nhau của nhà cung cấp.
-- d. Tạo INDEX cho mã loại. Điều gì sẽ xảy 

-- Tạo FULL TEXT SEARCH cho hóa đơn nhập 
delimiter  
